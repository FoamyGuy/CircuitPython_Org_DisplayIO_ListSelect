...
setup(
    ...
    url="https://github.com/circuitpython/CircuitPython_Org_DisplayIO_ListSelect.git",
    # Author details
    author="Tim Cocks",
    ...
    keywords="adafruit blinka circuitpython micropython displayio_listselect displayio widget "
    "list listselect select",
    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    # TODO: IF LIBRARY FILES ARE A PACKAGE FOLDER,
    #       CHANGE `py_modules=['...']` TO `packages=['...']`
    py_modules=["displayio_listselect"],
)
